	...
	*/
    function education_web_services_section() { 
    	...
    	if( get_theme_mod( 'education_web_services_area_options', 1 ) == 1 ){ 
			...
			$fscontainer = get_theme_mod('education_web_fservices_container', 'layout2');
			
			$flayout = get_theme_mod('education_web_fservices_layout', 'layout2');

			if(!empty( $featuresservices )) { ?>

		    	<section class="features hs-section <?php echo esc_attr( $flayout ); ?>">
					<div class="<?php if( $fscontainer == 'layout2' ){ echo esc_attr( 'container' ); }else { echo esc_attr( 'fullwidth' ); } ?>">
						<div class="row">
							<?php
								$count = 1;
							...
							<?php }else{ ?>
								...
								<div class="features-single features-<?php echo intval( $count ); ?>">
									<?php if(!empty( $fservices->services_icon )){ ?>

										<i class="<?php echo esc_attr( $fservices->services_icon ); ?>"></i>
						    ...
						    <div class="single-course">
						    	...
						    	<?php if ( has_post_thumbnail() ){ ?>
							        ...
							        <div class="single-course-image">
							            ...
							            <?php education_web_post_thumbnail(); ?>
										
							            <?php if( !empty( $course_price ) ){ ?><div class="ribbon premium"><?php echo esc_attr( $course_price ); ?></div><?php } ?>
						        ...
						        <div class="single-course-text">
						            ...
						            <div class="course-details">
						                <a href="<?php the_permalink(); ?>"><?php esc_html_e('More Details','education-web'); ?></a>
						            </div>
						        </div>
						    </div>
						</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="blog-list">
									<?php
										...
										$numberpost = get_theme_mod('education_web_display_number_posts', 4 );
