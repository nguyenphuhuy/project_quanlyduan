                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo_dm" class="collapse">
                            ...
                            <li>
                                <a href="list_danhmucbaiviet.php">Danh sách</a>
                            </li>
                        </ul>
                    </li> 
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo_sl"><i class="fa fa-fw fa-file"></i> Slide <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo_sl" class="collapse">
                            <li>
                                <a href="add_slide.php">Thêm mới</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo_us"><i class="fa fa-fw fa-file"></i> User <i class="fa fa-fw fa-caret-down"></i></a>
