...
<?php 
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $sql_namecate = "SELECT * from cate where id = $id";
        $query_namecate = mysqli_query($con,$sql_namecate);
        if (mysqli_num_rows($query_namecate) > 0) {
             ...
             <div class="container trangcon_wrapper">
                <div class="row ">
                    ...
                    <div class="col-sm-9 ">
                            ...
                            <?php 
                            if ($result_namecate['parent_id']==0) : ?>
                            <div class="main">
                               <img style="width:100%;max-height: 280px; " src="../<?php echo $result_namecate['image']; ?>">
                            

                                <h4><?php echo $result_namecate['name']; ?></h4>

                                <p style="font-size: 14px;"><?php echo $result_namecate['sapo']; ?> </p>
                                <b><a href="http://ntt.edu.vn"><i class="fa fa-chevron-circle-right mr-2 c-blue-a5"></i>http://ntt.edu.vn</a></b>

                             </div>
                            <hr>
                        <?php 
                            $id_catecon = $result_namecate['id'];
                            $sql_catecon = "SELECT * FROM cate where parent_id = $id_catecon";
                            $query_catecon = mysqli_query($con,$sql_catecon);
                            while($result_catecon = mysqli_fetch_assoc($query_catecon)):
                        ?>
                        <div class="main1">
                            <div class="row">
                                <div class="col-md-3 col-6 linhtinh1">
                                    <img class="img-fluid" style="min-height: 120px"  src="../<?php echo $result_catecon['image']; ?>" alt="alternative">
                                </div>
                                <div class="col-md-9 col-6 linhtinh2">
                                    <div>
                                        <h5><a href="index.php?id=<?php echo $result_catecon['id']; ?>"><?php echo $result_catecon['name']; ?></a></h5>
                                        <p><?php echo $result_catecon['sapo']; ?></p>
                                    </div>
                                    <div class="row">
                                        <?php 
                                        $id_baiviet = $result_catecon['id'];
                                        $sql_baiviet = "SELECT * from baiviet where cate_id = $id_baiviet";
                                        $query_baiviet = mysqli_query($con,$sql_baiviet) or die(mysqli_error($con));
                                        while($result_baiviet = mysqli_fetch_assoc($query_baiviet)):
                                       
                                        ?>
                                        <div class="col-xl-6 col-sm-12 linhtinh3">
                                            <a class="fix-a" href="detail.php?id=<?php echo $result_baiviet['id']; ?>">&gt; <?php echo $result_baiviet['name']; ?></a>
                                        </div>
